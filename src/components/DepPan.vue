    ...
    <div class="main">
        ...
        <div class="dept-list">
            ...
            <div class="dept">
                ...
                <div class="ss-card jump-card" @click="openLink('https://github.com/SAWARATSUKI/ServiceLogos')">
